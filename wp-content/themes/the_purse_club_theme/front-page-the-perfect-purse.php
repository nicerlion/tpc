<?php 
/**
 * Template Name: The Perfect Purse Home Design
 */
get_header(); ?>
	...
	<main role="main">
		...
		<section id="howItWorks" class="tpp-how-it-works" style="background-color: #f3f3f3">
            <div class="container">
                <div class="row">
		...
		<section id="whyWomenLove" class="tpp-why-women-love">
			<div class="container">
				<div class="row">
