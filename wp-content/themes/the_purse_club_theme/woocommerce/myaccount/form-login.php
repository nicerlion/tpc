...
<?php endif; ?>
		...
		<div class="container-fluid loginp-main-container">
			<div class="loginp-bar-contain">
				...
				<form class="woocommerce-form woocommerce-form-login login loginp-info-section" method="post">
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide login-fields-sec">
						<label for="username"><?php _e( 'Username or email address', 'woocommerce' ); ?> <span class="required">*</span></label>
						<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( $_POST['username'] ) : ''; ?>" placeholder="EMAIL ADDRESS" />
					</p>
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide login-fields-sec">
					...
					<p class="form-row">
						...
						<input type="submit" class="woocommerce-Button button log-in-button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
					...
					<p class="woocommerce-LostPassword lost_password">
						...
						<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( 'RESET HERE', 'woocommerce' ); ?></a>
					</p>
