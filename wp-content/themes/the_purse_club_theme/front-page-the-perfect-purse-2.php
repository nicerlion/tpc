<?php 
/**
 * Template Name: The Perfect Purse Home Design 2
 */
get_header(); ?>
	...
	<main role="main">
		...
		<section class="tpp-ready tpp-video-container" style="background-color: #f0f0f0">
            <div class="tpp-video-box">
                <iframe src="https://www.youtube.com/embed/pDm4f63wEFk?autoplay=1&controls=0&rel=0&showinfo=0&loop=1&playlist=pDm4f63wEFk" class="youtube-player" type="text/html" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
            </div>
		</section>
