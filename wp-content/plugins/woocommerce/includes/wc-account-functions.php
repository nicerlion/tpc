...
function wc_get_account_menu_items() {
	$endpoints = array(
		...
		'customer-service' => get_option( 'woocommerce_customer_service_address_endpoint', 'customer-service' ),
		'customer-logout' => get_option( 'woocommerce_logout_endpoint', 'customer-logout' ),
	);

	$items = array(
		'dashboard'       => __( 'Dashboard', 'woocommerce' ),
		'edit-address'    => __( 'Payment and Shipping', 'woocommerce' ),
		'orders'          => __( 'Orders', 'woocommerce' ),
		'customer-service' => __( 'Customer service', 'woocommerce' ),
